...
select * from customer_table_change;

insert into customer values(263136,'Janhavi','Singh','tanner39@smith.com','595 Benjamin Forge Suite 124','Michaelstad','Connecticut','Cape Verde',current_timestamp());
...
select * from customer_history where customer_id in (72,73,263136);
select * from customer_table_changes;
select * from  customer where customer_id in (72,73,263136);
...
select CUSTOMER_ID, FIRST_NAME, LAST_NAME, EMAIL, STREET, CITY,STATE,COUNTRY,
      ...
      from (select CUSTOMER_ID, FIRST_NAME, LAST_NAME, EMAIL, STREET, CITY,STATE,COUNTRY,UPDATE_TIMESTAMP
            from SNOWFLAKE_SCD_PROJECT.SCD.CUSTOMER_TABLE_CHANGE
